    ...
    >
      ...
      <div className="mt-6 flex">
        <input
          ...
          required
          className="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-violet-500 focus:outline-none focus:ring-4 focus:ring-violet-500/10 sm:text-sm dark:border-zinc-700 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-violet-400 dark:focus:ring-violet-400/10"
        />
...
function Resume() {
  let resume: Array<Role> = [
    {
      ...
      title: 'Sr. Consultant and Software Engineer',
    ...
    {
      company: 'Cincom',
      title: 'Salesforce Business Analyst/Admin',
    ...
    },
    {
      ...
      title: 'Investment Compliance Associate',
      logo: logoFifthThird, // Add your Fifth Third Securities logo path here
      start: 'July 2011',
      end: 'August 2015',
    },
  ];
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/public/updated-resume-8-29-24.pdf"
        variant="secondary"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm Bradley Dirheimer, a Senior Consultant and Software Engineer based in Hamilton,
            Ohio. With over a decade of experience in IT, I specialize in Salesforce, data platforms, and 
            building cutting-edge solutions for businesses. My goal is to empower companies to 
